          ...
          <section class="con">
            <div>
              <article class="seccion1">
                <h1 class="titulos">¡Somos la comunidad deportiva que une a los barrios! ⚽</h1>
                <p class="texto">Nuestra misión es conectar a los deportistas de todos los rincones de Colombia y fomentar el deporte en nuestras comunidades. Queremos que todos tengan la oportunidad de practicar su deporte favorito, competir y divertirse.</p>
              </article>
              <article class="seccion2">
                <h1 class="titulos">¿Qué hacemos?</h1>
                <ul>
                  <li class="texto">• Organiza tus propios torneos: ¡Crea eventos deportivos personalizados para cualquier deporte y define las reglas!</li>
                  <li class="texto">• Únete a ligas existentes: Encuentra grupos de jugadores con tu mismo nivel y pasión.</li>
                  <li class="texto">• Busca partidos 1 vs 1: ¡Enfréntate a otros deportistas y mejora tus habilidades!</li>
                  <li class="texto">• Encuentra canchas cercanas: ¡Nunca más busques un lugar para jugar!</li>
                  <li class="texto">• Recibe notificaciones de eventos: ¡Mantente al día de todos los torneos y partidos cerca de ti!</li>
                </ul>
              </article>
            </div>
          </section>
          ...
          <section class="con">
            <div>
              <article class="seccion3">
                <h3 class="titulos">¿Por qué elegirnos?</h3>
                <ul>
                  <li class="texto">• Premios garantizados: ¡Todos los fondos recaudados en cada evento se entregarán al ganador!</li>
                  <li class="texto">• Confianza y transparencia: Nuestra plataforma asegura un entorno seguro y justo para todos los usuarios.</li>
                  <li class="texto">• Comunidad activa: ¡Conéctate con otros deportistas, comparte tus logros y haz nuevos amigos!</li>
                </ul>
              </article>
              <article class="seccion4">
                <p class="texto">Nuestra visión es convertirnos en la plataforma deportiva más grande y activa de Colombia, donde todos los amantes del deporte puedan encontrar su lugar. Queremos crear un espacio seguro y divertido para que las personas se conecten, compitan y crezcan juntos.</p>
                <h3 id="fin" class="titulos">¡Únete a nosotros y sé parte de esta revolución deportiva!</h3>
              </article>
            </div>
          </section>
        </div>
...
<div class="content">
  <div class="benefits">
    <div class="basic-marquee basic-marquee-1">
      <a class="social-media-link" href="https://web.whatsapp.com/">
        <button class="button">
          <svg
...
.content::before {
  ...
  width: 40px;
  height: 96px;
  background-image: linear-gradient(90deg, #ff00001c, transparent);
  z-index: 2;
